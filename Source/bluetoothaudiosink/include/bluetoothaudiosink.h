...
EXTERNAL uint32_t bluetoothaudiosink_register_state_update_callback(const bluetoothaudiosink_state_update_cb callback, void *user_data);

EXTERNAL uint32_t bluetoothaudiosink_unregister_state_update_callback(const bluetoothaudiosink_state_update_cb callback);
